...
function Basket() {
    ...
    const totalCountProducts = useSelector(state => state.cartSlice.products).reduce((sum, obj) => {
        ...
        <div className="cart">
            <div className="cart__top">
                <h2 className="content__title"><svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    Корзина</h2>
                <button onClick={clearBasket} className="cart__clear">
            ...
            <div className="cart__items">
                {addedProducts.map((obj) => {
                    return <ProductsBasketCard key={obj.id} {...obj} />
                })}

            </div>
            <div className="cart__bottom">
                <div className="cart__bottom-details">
                    <span> Всего пицц: <b>{totalCountProducts} шт.</b> </span>
