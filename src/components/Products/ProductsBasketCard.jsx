...
import { addProduct, minusProduct, revoveProduct } from '../../redux/slises/cartSlice'

function ProductsBasketCard({ title, imageUrl, price, count, activeType, id }) {
    ...
    const onClickMinus = () => {
        if (count === 1) {
            dispatch(revoveProduct(id));
        } else {
            dispatch(minusProduct({
                id
            }))
        }
...
export default ProductsBasketCard